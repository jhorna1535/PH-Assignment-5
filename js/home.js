// Input Value with id Function
  ...
  function leaderOfFunction(inputId, donateId, location) {
...
// Noakhali Donate done 
  document.getElementById("btn-noakhali").addEventListener("click", function (event) {
    ...
    leaderOfFunction("input-noakhali", 'noakhali', 'Flood at Noakhali, Bangladesh');
...
// Feni Donate done 
  ...
  document.getElementById("btn-feni").addEventListener("click", function (event) {
    ...
    leaderOfFunction("input-feni", 'feni' , 'Flood Relief in Feni,Bangladesh');
...
// Quota Movement donate done
  ...
  document.getElementById("btn-quota").addEventListener("click", function (event) {
    ...
    leaderOfFunction("input-quota", 'quota', 'Aid for Injured in the Quota Movement, Bangladesh');
